...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	SUBROUTINE gX0(l,g_i,f1,f2,gX_0)
	...
	complex(kind=8),dimension(c0:c1),intent(out) :: gX_0
	...
	call Fermion_Propagator(l,nvec,S_Prop)
	   ...
	   gX_0(x0) = mat3(1,1)+mat3(2,2)+mat3(3,3)+mat3(4,4)

	   enddo

 	gX_0(:) = 0.5d0*dimrep*gX_0(:)

	END SUBROUTINE gX0


	END MODULE TreeLevel_gX
